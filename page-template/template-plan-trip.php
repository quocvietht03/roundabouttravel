<?php
/*
	Template Name: Plan My Trip Classic

Header included these JS to make form works
<script type='text/javascript' src='https://www.roundabouttravel.com.au/wp-content/themes/rat/modules/plan-my-trip/js/jquery-ui-1.10.4.custom.min.js?ver=4.8.6'></script>
<script type='text/javascript' src='https://www.roundabouttravel.com.au/wp-content/themes/rat/modules/plan-my-trip/js/jquery.form.js?ver=4.8.6'></script>
<script type='text/javascript' src='https://www.roundabouttravel.com.au/wp-content/themes/rat/modules/plan-my-trip/js/bookmytrip.js?ver=4.8.6'></script>
*/
?>
        ...
        <div class="content-narrow">
            ...
            <div id="main" role="main" class="clearfix">
                ...
                <div class="continentDetailsform" style="display:none;">
                    ...
                    <section class="continentSelect" style="padding-left:200px;"><input type="radio"
                            name="continentSelect" value=""></section>
                </div>

                <div class="continentSelectform" style="display:none;">
                    <p class="question">What will be the next continent you visit?</p>
                    <section class="narrow continentSelect continentOne"><input type="radio" name="continentOne"
                            value=""></section>
                    <section class="narrow continentSelect continentTwo"><input type="radio" name="continentTwo"
                            value=""></section>
                    <section class="narrow continentSelect continentThree"><input type="radio" name="continentThree"
                            value=""></section>
                    <section class="narrow continentSelect continentFour"><input type="radio" name="continentFour"
                            value=""></section>
                    <section class="narrow continentSelect continentFive"><input type="radio" name="continentFive"
                            value=""></section>
                    <section class="narrow continentSelect continentSix"><input type="radio" name="continentSix"
                            value=""></section>
                ...
                <div class="itineraryform" style="display:none;">
                    ...
                    <div class="question-box">
                        <p class="question">When would you like to leave Australia?
                            Select your preferred departure date.</p>
                ...
                <div class="previewform" style="display:none;">
                    <div class="question-box">
                        <p>Fill in your passenger details as well as your personal details, and then preview your trip
                            to confirm your details are correct before submitting your trip to RoundAbout Travel.</p>
                    </div>
                    <div class="question-box">
                        <dl class="result">
			...
			?>
                ...
                <input type="hidden" id="bookingdirectory" value="<?php print $bookAppFolder; ?>"
                    style="display:none;" />
