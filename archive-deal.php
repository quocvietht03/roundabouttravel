                ...
                <div class="deal-items">
                    ...
                    <div class="deal-item">
                        <div class="deal-thumbnail">
							...
							?>
                            <?php if( !empty($text_box_item) ) : ?>
                            <div class="deal-icon-box">
                                <div class="deal-icon-box-item"
                                    style="background: <?php echo $icon_background_color; ?>">
                                    <?php if ( !empty( $icon_box_item ) ) { ?><img
                                        src="<?php echo $icon_box_item; ?>" /><?php } ?><?php if ( !empty( $text_box_item ) ) { ?><span><?php echo $text_box_item; ?></span><?php } ?>
                                </div>
                            </div>
                            <?php endif; ?>
                        ...
                        if ( !empty( $price ) ) {
                          ?>
                            <div class="deal-price"><span>From</span> $<?php echo $price; ?>
                                <?php if ( $price_tax == '1' ) : ?>inc taxes<?php endif; ?></div>
                            <?php
                        }
                      ?>
                        </a>
...
<section class="deals-trustpilot-ss">
    <div class="container">
        ...
        <div class="trustpilot-widget" data-locale="en-US" data-template-id="53aa8912dec7e10d38f59f36"
            data-businessunit-id="558011f70000ff0005803e84" data-style-height="140px" data-style-width="100%"
            data-theme="light" data-schema-type="Organization" data-stars="1,2,3,4,5">
