<?php
namespace PJElementorWidgets\Widgets\DealsGridBusinessClass;
...
class PJ_DealsGridBusinessClass extends Widget_Base {

	public function get_name() {
		return 'pj-deals-grid';
	}

	public function get_title() {
		return __( 'Deals Grid Business Class', 'text-domain' );
	}
											...
											<div class="deal-content">
												...
												<?php
				  								...
				  								$price_tax = get_field( 'deal_price_tax' );
													if ( !empty( $price ) ) {
														?>
															<div class="deal-price"><span>From</span> $<?php echo $price_fm; ?> <?php if ( $price_tax ) : ?><?php echo $price_tax; ?><?php endif; ?></div>
														<?php
													}
												?>
												<div class="deal-desc">
